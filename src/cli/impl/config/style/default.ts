...
export default class DefaultConfig extends IConfig {
    ...
    constructor() {
        ...
        this.format.name.format =
            "{:Bright.Green | name} " + "{'v' | :Bright.Black | version?}";
        this.format.name.args = [];
        // No need for positional args here, since we are using props

        // Default usage format
        this.format.usage.format =
            "{:Cyan} {:Bright.Green | name} {:Bright.Black}";
        ...
        this.format.error.format =
            "{:Bold.Bright.Red} {:Bright.Red | Error.message}";
        ...
        this.format.command.item.format =
            "{:Bright.Black} " +
